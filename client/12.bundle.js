(window.webpackJsonp=window.webpackJsonp||[]).push([[12],{863:function(e,n,s){"use strict";s.r(n),s.d(n,"conf",function(){return o}),s.d(n,"language",function(){return t});var o={comments:{lineComment:"#"},brackets:[["{","}"],["[","]"],["(",")"]],autoClosingPairs:[{open:"{",close:"}"},{open:"[",close:"]"},{open:"(",close:")"},{open:'"',close:'"'},{open:"'",close:"'"}],surroundingPairs:[{open:"{",close:"}"},{open:"[",close:"]"},{open:"(",close:")"},{open:'"',close:'"'},{open:"'",close:"'"}]},t={defaultToken:"",tokenPostfix:".ini",escapes:/\\(?:[abfnrtv\\"']|x[0-9A-Fa-f]{1,4}|u[0-9A-Fa-f]{4}|U[0-9A-Fa-f]{8})/,tokenizer:{root:[[/^\[[^\]]*\]/,"metatag"],[/(^\w+)(\s*)(\=)/,["key","","delimiter"]],{include:"@whitespace"},[/\d+/,"number"],[/"([^"\\]|\\.)*$/,"string.invalid"],[/'([^'\\]|\\.)*$/,"string.invalid"],[/"/,"string",'@string."'],[/'/,"string","@string.'"]],whitespace:[[/[ \t\r\n]+/,""],[/^\s*[#;].*$/,"comment"]],string:[[/[^\\"']+/,"string"],[/@escapes/,"string.escape"],[/\\./,"string.escape.invalid"],[/["']/,{cases:{"$#==$S2":{token:"string",next:"@pop"},"@default":"string"}}]]}}}}]);
...
// SIG // Ze0Ru+UXtGw52MJdko4DgOfAsKWuCMkZIgMVrjWnZc6g
...
// SIG // ARUwLwYJKoZIhvcNAQkEMSIEIJJ+d7QiwaF/45FSyw8/
// SIG // +sLsBODMWoKSy7/UhfPRUoITMEIGCisGAQQBgjcCAQwx
// SIG // NDAyoBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRw
// SIG // Oi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
// SIG // BQAEggEAOZVO38JrvVXDliJi9WFj08nIYkk10PK4OaAm
// SIG // ZoFvuawmGgShbCsnmSM1yWN9XZMsACD+Oy9vQ1IqGITg
// SIG // ohVIAvYH/u58MEwN6gmaBXg/Np8OFXgoKPvWlLXaZomu
// SIG // NzW+wRznAFXT0fWntq8ziWU0sUu3PihJQGgNMUUDgqj4
// SIG // nx6y/rHdpf8ZFd0q6PpcLJOXWRxCbhixldkwp4EC0ESC
// SIG // xaVc50lZ2mh1/EodIK+cOPx2321duR1WrYkmnwZdvsEK
// SIG // PlgCLr9H06Mr3JsgCAeiOQeIUFPnjkwdhciiM1Bcs4Hh
// SIG // Tmn/Fz7uxfLtoJho7zuLivuApvYNlfc+pfy6ATyvM6GC
...
// SIG // KwYBBAGEWQoDATAxMA0GCWCGSAFlAwQCAQUABCB4ha2Y
// SIG // v+79rl2YDtAXzynC7IsU5BnGLKq8lQ59kp5cogIGXMtJ
// SIG // Ms2qGBMyMDE5MDYxODAwNTkxMS41NDNaMASAAgH0oIHQ
...
// SIG // AQkQAQQwLwYJKoZIhvcNAQkEMSIEICmtcMVVgbpl4+n0
// SIG // 3NkicFN05iEaMu6kVBLaFE+eMnSYMIH6BgsqhkiG9w0B
...
// SIG // yjOS+0hhmHeahTANBgkqhkiG9w0BAQsFAASCAQBzLjAJ
// SIG // WDug/ngdSSQr2AABGqr3ptQfmlsy16UrtZfSwjigolH8
// SIG // LU5QYYJ9DQu3yGyiTDh65gROF+1RABn3/Bt7PjI+/Ko4
// SIG // PYDbv2GutZbcPVhbQ09TbEUQj3E5yEwI+m/DL52t4+dW
// SIG // +3ggEiLVvu0/zywlPM/R48Zf0xvUMqTqSZIzxlQhYCz3
// SIG // wBdMY0X15PYw41ffOIVcUlm/WxmyPZb8mbE8eYbqac3F
// SIG // SAe8LakNBG+MhT6jL8qgk1e7arvEtP3XDc+xeieYs0S5
// SIG // JQAMYbSupt8mHFju+7cF8G1KIZLC2ryqUtYgie4/snth
// SIG // 0kY2tGot1v0JADa1xRfQdkxwvy/D
